...
//we pass this.state because it will only change when the state is actualluy changed,
//with the previous version, it re-rendered everytimer the provider changed
    return (
...
// the childrens are all the other elements
